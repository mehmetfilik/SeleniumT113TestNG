...
public class C01_RaporluaAmazonSearch extends TestBaseRapor {
    ...
    public void test01() {
        ...
        String actaulSonucYazisi = amazonPage.aramaSonucuElementi.getText();
        String expectedIcerik = ConfigReader.getProperty("amazonExpectedIcerik");

        Assert.assertTrue(actaulSonucYazisi.contains(expectedIcerik));
